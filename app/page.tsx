    ...
    <main className="mx-auto max-w-7xl space-y-10 px-5 py-10">
      <div className="flex items-center bg-secondary md:h-96">
        <div className="space-y-7 p-10 text-center md:w-1/2">
          ...
          <p>
            Tough day? Credit card maxed out? Buy some expensive stuff and get
            happy agian
          </p>
          <Button asChild>
            <Link href="/shop">
...
function LoadingSkeleton() {
  return (
    <div className="flex flex-col gap-5 p-12 sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
